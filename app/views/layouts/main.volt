                ...
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                {{ image('img/avatar2.png', 'class':'img-circle', 'alt': 'User Image') }}
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                {{ image('img/avatar.png', 'class':'img-circle', 'alt': 'User Image') }}
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span><!-- <shiro:principal property="nome"/>--> <i class="caret"></i></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header bg-light-blue">
                                {{ image('img/avatar3.png', 'class':'img-circle', 'alt': 'User Image') }}
                                <p>
                                    <!-- <shiro:principal property="nome"/> -->
                                    <small>Member since Nov. 2012</small>
                                </p>
                            </li>
                            <li class="user-footer">
                                <div class="pull-left">
                                    {{ link_to("minhaconta/index", t("minha_conta"), 'class': 'btn btn-default btn-flat') }}
                                </div>
                                <div class="pull-right">
                                    <a href="${createLink(controller: 'autenticacao', action: 'sair')}" class="btn btn-default btn-flat">
                                        {{ t('sair') }}
                                    </a>
                                </div>
                            </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p><!--<g:message code="ola"/>, <shiro:principal property="nome"/>--></p>
                    </div>
                </div>
                <!-- search form -->
                <form action="#" method="get" class="sidebar-form">
                    <div class="input-group">
                        <input type="text" name="q" class="form-control" placeholder="{{ t('localizar')  }}"/>
